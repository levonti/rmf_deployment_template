[![CI image builder](https://github.com/levonti/rmf_deployment_template/actions/workflows/build-images.yaml/badge.svg?branch=main)](https://github.com/levonti/rmf_deployment_template/actions/workflows/build-images.yaml)
[![CI Nightly](https://github.com/levonti/rmf_deployment_template/actions/workflows/nightly.yaml/badge.svg?branch=main)](https://github.com/levonti/rmf_deployment_template/actions/workflows/nightly.yaml)
